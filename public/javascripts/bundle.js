...
var _slickCarousel = require('./components/slick-carousel.js');

var _slickCarousel2 = _interopRequireDefault(_slickCarousel);

var _fixedheader = require('./components/fixedheader.js');
...
var _numberinputs = require('./components/numberinputs.js');

var _numberinputs2 = _interopRequireDefault(_numberinputs);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

},{"./components/fixedheader.js":4,"./components/modal.js":5,"./components/numberinputs.js":6,"./components/slick-carousel.js":7}],4:[function(require,module,exports){
'use strict';
...
FixedHeader.prototype = {
    ...
    _onScroll: function _onScroll() {
        ...
        if (this.scrollPos > this.headerHeight) {
            ...
            var _shouldFix = false;
            this._onChange(_shouldFix);
        }
    },
    ...
    _onChange: function _onChange(shouldFix) {
        if (shouldFix !== this.fixed) {
            ...
            this.fixed ? this._fix(this.$nav, this.$header) : this._unfix(this.$nav, this.$header);
        }
        return false;
    },
...
var _slickCarouselBrowserify = require('slick-carousel-browserify');

var _slickCarouselBrowserify2 = _interopRequireDefault(_slickCarouselBrowserify);
...
exports.default = (0, _jquery2.default)(document).ready(function () {
    (0, _slickCarouselBrowserify2.default)((0, _jquery2.default)('.slick-slider'), sliderOptions);
});

},{"jquery":1,"slick-carousel-browserify":2}]},{},[3]);
